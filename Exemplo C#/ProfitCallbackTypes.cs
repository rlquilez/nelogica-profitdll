...
public delegate void TTradeCallback(
    TAssetID assetId,
...
public delegate void TOrderChangeCallBack(
    TAssetID assetId,
    int nCorretora,
    int nQtd,
    int nTradedQtd,
...
public delegate void TOrderChangeCallBackV2(
    TAssetID assetId,
    int nCorretora,
    int nQtd,
    int nTradedQtd,
...
public delegate void TAccountCallback(
    int nCorretora,
...
public delegate void TConnectorBrokerAccountListCallback(int brokerId, [MarshalAs(UnmanagedType.Bool)] bool hasChanged);
